...
void show_delete_dialog(SidebarState& sidebar, EditorState& editor, int index) {
    ...
    sidebar.delete_dialog = lv_obj_create(screen);
    lv_obj_set_size(sidebar.delete_dialog, 280, 120);
    lv_obj_center(sidebar.delete_dialog);
    lv_obj_set_style_bg_color(sidebar.delete_dialog, theme.sidebar_bg, 0);
    lv_obj_set_style_bg_opa(sidebar.delete_dialog, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(sidebar.delete_dialog, 2, 0);
    lv_obj_set_style_border_color(sidebar.delete_dialog, theme.sidebar_btn_hover, 0);
    lv_obj_set_style_radius(sidebar.delete_dialog, 8, 0);
    lv_obj_set_style_pad_all(sidebar.delete_dialog, 15, 0);
    lv_obj_set_flex_flow(sidebar.delete_dialog, LV_FLEX_FLOW_COLUMN);
    lv_obj_set_flex_align(sidebar.delete_dialog, LV_FLEX_ALIGN_SPACE_BETWEEN, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
    ...
    sidebar.delete_dialog_label = lv_label_create(sidebar.delete_dialog);
    lv_label_set_text(sidebar.delete_dialog_label, msg.c_str());
    lv_obj_set_style_text_color(sidebar.delete_dialog_label, theme.sidebar_btn_text, 0);
    lv_obj_set_style_text_font(sidebar.delete_dialog_label, &lv_font_montserrat_16, 0);
    lv_obj_set_style_text_align(sidebar.delete_dialog_label, LV_TEXT_ALIGN_CENTER, 0);
    
    lv_obj_t* btn_row = lv_obj_create(sidebar.delete_dialog);
    lv_obj_remove_style_all(btn_row);
    lv_obj_set_size(btn_row, LV_PCT(100), 40);
    lv_obj_set_flex_flow(btn_row, LV_FLEX_FLOW_ROW);
    lv_obj_set_flex_align(btn_row, LV_FLEX_ALIGN_SPACE_EVENLY, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
    
    sidebar.delete_btn = lv_btn_create(btn_row);
    lv_obj_set_size(sidebar.delete_btn, 100, 35);
    lv_obj_set_style_bg_color(sidebar.delete_btn, theme.sidebar_delete, 0);
    lv_obj_set_style_radius(sidebar.delete_btn, 4, 0);
    
    lv_obj_t* del_label = lv_label_create(sidebar.delete_btn);
    lv_label_set_text(del_label, "Delete");
    lv_obj_center(del_label);
    lv_obj_set_style_text_color(del_label, theme.sidebar_btn_text, 0);
    lv_obj_set_style_text_font(del_label, &lv_font_montserrat_14, 0);
    
    sidebar.cancel_btn = lv_btn_create(btn_row);
    lv_obj_set_size(sidebar.cancel_btn, 100, 35);
    lv_obj_set_style_bg_color(sidebar.cancel_btn, theme.sidebar_btn_normal, 0);
    lv_obj_set_style_radius(sidebar.cancel_btn, 4, 0);
    
    lv_obj_t* cancel_label = lv_label_create(sidebar.cancel_btn);
...
void show_restore_dialog(SidebarState& sidebar, EditorState& editor, int deleted_index) {
    ...
    sidebar.restore_dialog = lv_obj_create(screen);
    lv_obj_set_size(sidebar.restore_dialog, 300, 130);
    lv_obj_center(sidebar.restore_dialog);
    lv_obj_set_style_bg_color(sidebar.restore_dialog, theme.sidebar_bg, 0);
    lv_obj_set_style_bg_opa(sidebar.restore_dialog, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(sidebar.restore_dialog, 2, 0);
    lv_obj_set_style_border_color(sidebar.restore_dialog, theme.sidebar_btn_hover, 0);
    lv_obj_set_style_radius(sidebar.restore_dialog, 8, 0);
    lv_obj_set_style_pad_all(sidebar.restore_dialog, 15, 0);
    lv_obj_set_flex_flow(sidebar.restore_dialog, LV_FLEX_FLOW_COLUMN);
    lv_obj_set_flex_align(sidebar.restore_dialog, LV_FLEX_ALIGN_SPACE_BETWEEN, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
    
    sidebar.restore_dialog_label = lv_label_create(sidebar.restore_dialog);
    lv_label_set_text(sidebar.restore_dialog_label, "This file was deleted.\nWould you like to restore it?");
    lv_obj_set_style_text_color(sidebar.restore_dialog_label, theme.sidebar_btn_text, 0);
    lv_obj_set_style_text_font(sidebar.restore_dialog_label, &lv_font_montserrat_16, 0);
    lv_obj_set_style_text_align(sidebar.restore_dialog_label, LV_TEXT_ALIGN_CENTER, 0);
    
    lv_obj_t* btn_row = lv_obj_create(sidebar.restore_dialog);
    lv_obj_remove_style_all(btn_row);
    lv_obj_set_size(btn_row, LV_PCT(100), 40);
    lv_obj_set_flex_flow(btn_row, LV_FLEX_FLOW_ROW);
    lv_obj_set_flex_align(btn_row, LV_FLEX_ALIGN_SPACE_EVENLY, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
    
    sidebar.restore_btn = lv_btn_create(btn_row);
    lv_obj_set_size(sidebar.restore_btn, 100, 35);
    lv_obj_set_style_bg_color(sidebar.restore_btn, lv_color_hex(0x4a7c4a), 0);
    lv_obj_set_style_radius(sidebar.restore_btn, 4, 0);
    
    lv_obj_t* restore_label = lv_label_create(sidebar.restore_btn);
    lv_label_set_text(restore_label, "Restore");
    lv_obj_center(restore_label);
    lv_obj_set_style_text_color(restore_label, theme.sidebar_btn_text, 0);
    lv_obj_set_style_text_font(restore_label, &lv_font_montserrat_14, 0);
    
    sidebar.restore_cancel_btn = lv_btn_create(btn_row);
    lv_obj_set_size(sidebar.restore_cancel_btn, 100, 35);
    lv_obj_set_style_bg_color(sidebar.restore_cancel_btn, theme.sidebar_btn_normal, 0);
    lv_obj_set_style_radius(sidebar.restore_cancel_btn, 4, 0);
    
    lv_obj_t* cancel_label = lv_label_create(sidebar.restore_cancel_btn);
    lv_label_set_text(cancel_label, "Cancel");
    lv_obj_center(cancel_label);
    lv_obj_set_style_text_color(cancel_label, theme.sidebar_btn_text, 0);
    lv_obj_set_style_text_font(cancel_label, &lv_font_montserrat_14, 0);
